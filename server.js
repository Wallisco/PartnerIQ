...
// Note: express.static is registered after the homepage route below
// so that the custom / route takes priority over index.html
...
// ── Assessment app direct route ───────────────────────────────────────────────
app.get('/app', (req, res) => {
  res.sendFile(path.join(__dirname, 'public', 'index.html'));
});

// ── Static assets (CSS, JS, images) ──────────────────────────────────────────
// Registered after custom routes so / serves home.html not index.html
